...
using ForumDatabasePreparedStatement = PreparedStatement<ForumDatabaseConnection>;
...
using ForumDatabaseTransaction = SQLTransaction<ForumDatabaseConnection>;
...
using ForumDatabaseQueryHolder = SQLQueryHolder<ForumDatabaseConnection>;
